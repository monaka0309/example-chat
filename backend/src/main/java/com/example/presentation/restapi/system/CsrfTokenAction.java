...
public class CsrfTokenAction {
    ...
    public static class CsrfTokenResponse {
        ...
        public CsrfTokenResponse(String csrfTokenValue, String csrfTokenHeaderName, String csrfTpokenParameterName) {
            this.csrfTokenValue = csrfTokenValue;
            this.csrfTokenHeaderName = csrfTokenHeaderName;
            this.csrfTokenParameterName = csrfTpokenParameterName;
        }
    }
}
